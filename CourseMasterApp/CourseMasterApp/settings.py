...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-dj*1+cs-30ivcjis+xd9d)a2&3xdf3uqf7hrm+2ae3^c4=m#j9')
...
CSRF_TRUSTED_ORIGINS = [
    origin.strip()
    for origin in os.environ.get('CSRF_TRUSTED_ORIGINS', 'https://*.up.railway.app').split(',')
    if origin.strip()
]
